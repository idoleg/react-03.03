function notifications(window) {
  ...
  function isPushSupported() {
    ...
    // Поддерживаются ли уведомления браузером пользователя
    ...
    // Предлагаем пользователю подписаться на push-уведомление
    ...
    function changePushStatus(status) {
        ...
        if (status) {
            ...
            pushImgElement.src = '../images/push_on.png';
        } else {
            pushElement.classList.remove("active");
            pushImgElement.src = "../images/push_off.png";
        }
    }
...
// Ненадежное решение, которое позволяет дождаться отрисовки страницы, прежде чем выполнить скрипт
