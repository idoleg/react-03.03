...
export const ChatList = ({chats, onCreateNewChat}) => {
                                ...
                                <div className="chat" key={id}>
                                    <ListItem alignItems="flex-start" component={Link} to={`/chats/${id}`} key={id}>
                                        <ListItemAvatar>
                                            <Avatar
                                                alt="Remy Sharp"
                                                src="https://avatars.mds.yandex.net/get-pdb/1211668/17b85b01-aef6-44aa-a372-945911d8600f/s1200"/>
                                        </ListItemAvatar>
                                        <ListItemText
                                            primary={chats[id].name}
                                            secondary={<React.Fragment > <Typography className="White" component="span" variant="body2">
                                                    {
                                                        chats[id]
