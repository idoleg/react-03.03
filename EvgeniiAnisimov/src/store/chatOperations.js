import { loadingChats, failedLoadedChats, addChat, initChats, sendMessage } from './chatActions';
...
export const sendMessageToBot = (botName, id, content) => async (dispatch, getState) => {
  ...
  // console.log("sendMessageToBot->data", aiml);
}
